...
export default function Privacy() {
    return (
        <PageLayout>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        this Agreement) refers to Securing the Cloud.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Securing the Cloud, accessible
                        from{" "}
                        <a
                            href="https://securing-the-cloud.vercel.app/"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://securing-the-cloud.vercel.app/
                        </a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: glostery@tcd.ie</li>
            </ul>
        </PageLayout>
    );
}